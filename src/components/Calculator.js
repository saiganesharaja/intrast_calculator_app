...
export default function Calculator() {
    ...
    return (
        ...
        <Box>
            <Grid style={{ margin: "200px 300px", border: "1px solid black", borderRadius: "5px", width: "700px", height: "450px", backgroundColor: 'white' }}>
                <Grid style={{ display: "flex", marginLeft: "20%" }}>
                ...
                <Grid style={{ display: "flex", marginLeft: "20%", marginTop: "20px" }}>
                    <Grid marginRight="20px">
                ...
                <Grid container style={{ padding: ' 0px 200px', height: "100px" }} >
                    <List
